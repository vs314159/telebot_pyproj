...
'''
    ...
    feedback = 'Який у вас формат навчання?'

    remains = 'Введіть номер телефону у форматі "380-ХХ-ХХХ-ХХ-ХХ"'

    guest = 'Клас! Будемо раді вам допомогти із вивченням англійської🤞 Що саме вам цікаво дізнатись про навчання?'

    price = 'Наразі доступні такі варіанти ☝️'

    test_level = """
Привіт! Запрошуємо тебе пройти невеликий тест на приблизне визначення рівня англійської :) 
Тест складається з 20 питань різної складності, які в основному перевіряють вашу граматику і лексику.
Саме тому тест НЕ Є 100% відображенням вашого рівня англійської. Дуже важливо після тестування пройти 
speaking частину із викладачем, який більш точно визначить ваш рівень та оцінить ваші спікінг навички!
Реді? Стеді? Гоу!"""

    test_level_done = '''
👨‍🏫 Для більш детальної оцінки рівня - запрошуємо вас пройти
speaking частину з викладачем нашої школи'''
