# Створено клас повідомлень від бота для зручності імпорту і використання у інших модулях
class Messages:
    start = '''
...
'''
    ...
    auth = 'Введіть своє Імя та Прізвище у такому форматі українською мовою: Петро Петренко'
